...
*/
function(b){"use strict";"object"==typeof a?b(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],b):b(jQuery)}(function(a){"use strict";var b={},c=0;/**
...
* @api public
*/
a.fn.once=function(d,e){"string"!=typeof d&&(
// Generate a numeric ID if the id passed can't be used as a CSS class.
d in b||(b[d]=++c),
// When the fn parameter is not passed, we interpret it from the id.
e||(e=d),d="jquery-once-"+b[d]);
// Remove elements from the set that have already been processed.
var f=d+"-processed",g=this.not("."+f).addClass(f);return a.isFunction(e)?g.each(e):g},/**
...
* @api public
*/
a.fn.removeOnce=function(b,c){var d=b+"-processed",e=this.filter("."+d).removeClass(d);return a.isFunction(c)?e.each(c):e}}),/**
* @file
...
//Set default content
d.showContent(a,e.eq([c.active]))},this.each(d.init)},jQuery.fn.extend(b)}(jQuery),/**
* @file
...
*/
function(a){a(".jSocial").jSocial()}(jQuery),b["true"]=a}({},function(){return this}());